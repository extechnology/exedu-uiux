    ...
    <div className="md:py-15 py-8">
      <div className="xl:flex gap-8 justify-between max-w-7xl mx-auto">
        ...
        <div className="content-center xl:w-3/5 px-5 pt-8 xl:pt-0 xl:px-0">
          ...
          <h1 className="md:text-5xl text-xl font-semibold md:py-3">
            SOLUTION FOR YOU
          </h1>
          <p className="md:text-xl text-sm pl-4 pt-3 md:pt-0 relative text-justify before:absolute before:left-4 md:before:top-0 before:h-full before:w-1 before:bg-fuchsia-500 before:content-[''] before:-translate-x-4 before:rounded">
